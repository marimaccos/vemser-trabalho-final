...
VALUES (seq_usuario.nextval, 'TAM123', 'senhasecreta', 'Companhia Tam', '');
INSERT INTO Usuario (id_usuario, login, senha, nome, tipo) 
...
VALUES (seq_companhia.nextval, '97450166000141', 'Tam Aviação', 1);
...
VALUES (seq_venda.nextval, 'CONCLUÍDO', TO_DATE(CURRENT_DATE, 'dd-mm-yyyy'), 1, 1);
